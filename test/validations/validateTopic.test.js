...
describe('validateTopic_function', () => {
  ...
  it('test_validate_topic_with_invalid_string', () => {
    expect(() => validateTopic('inv')).toThrow(
      'Invalid topic: The type of topic should be string or the lenght should not be less than 5 and more than 20'
    );
    expect(() => validateTopic('invalidstringinvalidmorethanlengthoftwenty')).toThrow(
      'Invalid topic: The type of topic should be string or the lenght should not be less than 5 and more than 20'
    );
  });
  ...
  it('test_validate_topic_with_non_string', () => {
    ...
    expect(() => validateTopic(true)).toThrow(
      'Invalid topic: The type of topic should be string or the lenght should not be less than 5 and more than 20'
    );
    expect(() => validateTopic(null)).toThrow(
      'Invalid topic: The type of topic should be string or the lenght should not be less than 5 and more than 20'
    );
    expect(() => validateTopic({ key: 'value' })).toThrow(
      'Invalid topic: The type of topic should be string or the lenght should not be less than 5 and more than 20'
    );
  });
});

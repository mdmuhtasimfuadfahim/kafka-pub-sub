...
describe('ProduceEvent_function', () => {
  ...
  it('test_promise_resolves_successfully_without_data_&_headers', async () => {
    // Arrange
    const topic = 'valid_topic';
    const event = 'valid_event';
  ...
  it('test_invalid_data_throws_error_with_invalid_headers', async () => {
    // Arrange
    const topic = 'valid_topic';
    const event = 'valid_event';
    const data = { validData: true };
  ...
  // Tests that the function throws an error when an invalid topic is provided.
  it('test_invalid_topic_throws_error_without_event', async () => {
    // Arrange
    const topic = '';
  ...
  // Tests that the function throws an error when an invalid event is provided.
  it('test_invalid_event_throws_error_without_topic', async () => {
    // Arrange
    const event = '';
